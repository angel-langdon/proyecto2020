...
por_dia = read_tsv('/Users/mazcu/Downloads/MHEST462500462020.txt') #Es un fichero cualquiera de día de la generalitat.
por_dia = as.data.frame(por_dia)
por_dia

a = setwd('/Users/mazcu/Documents/UPV/2º/PROY 2/estacionesCSV/')
b = list.files(path = a)
